...
import com.tesis.medico.tareas.WSEstadisticas;
...
public class GraficaEstadistica extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		WSEstadisticas tarea = new WSEstadisticas();
        tarea.setParams(this);
        tarea.execute(bundle.getString("FechaInicio"), bundle.getString("FechaFin"), bundle.getString("TipoChequeo"),
        		bundle.getString("NumeroId"), bundle.getString("TipoId"));
