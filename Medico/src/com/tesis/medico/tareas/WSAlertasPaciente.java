...
public class WSAlertasPaciente  extends AsyncTask<String, Void, Void> {

	private AlertasPacienteActivity mContext;
	private String resultado;
	private ArrayList<RegistroNotificaciones> registro = null;
	
	public void setParams(AlertasPacienteActivity context){
		mContext = context;
	}
	...
	protected Void doInBackground(String... params) {
		...
		final String METHOD_NAME = "obtenerAlertasPaciente";
		final String SOAP_ACTION = "http://ws.simop.com/SIMOP/obtenerAlertasPacienteRequest";
